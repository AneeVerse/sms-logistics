...
export default function FloatingPoster() {
  return (
    <section className="relative z-10 -mt-8 md:-mt-10 lg:-mt-45 -mb-14 md:-mb-20 lg:-mb-24">
      <div className="mx-auto max-w-[1500px] px-6 md:px-10 lg:px-12">
        <div className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-xl shadow-[#0a0e2a]/10 ring-1 ring-black/10">
          {/* Background image */}
          <Image
          ...
          <div className="absolute inset-0 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
            <h3 className="text-white text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight max-w-3xl">
              Streamline Your Logistics
              <br className="hidden md:block" /> Today!
            </h3>
            <p className="mt-4 text-white/85 max-w-2xl text-sm md:text-base">
            ...
            <div className="mt-6">
              <Link
                href="#contact"
                className="inline-flex items-center gap-2 rounded-full bg-white/90 hover:bg-white text-[#0B2D8D] px-6 py-3 text-sm font-semibold transition-colors shadow-md"
              >
                Get a Free Quote
                <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#e8edff]">
