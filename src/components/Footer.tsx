...
export default function Footer() {
	...
	return (
		<footer className="relative -mx-2 sm:-mx-3 md:-mx-4 lg:-mx-6 -mb-2 sm:-mb-3 md:-mb-4 lg:-mb-6 bg-[#070E31] text-white pt-32 sm:pt-40 md:pt-48 lg:pt-56 pb-3 md:pb-4 lg:pb-6" style={{width: '100vw', marginLeft: 'calc(-50vw + 50%)'}}>
